  ...
  return (
    <div className="restaurant-card">
      ...
      <div className="card-info">
        <p>{restaurant.RestaurantList[0].info.name}</p>
        <p>Rating : {RestaurantList[0].info.avgRating}</p>
      </div>
    </div>
  );
};
const Body = () => {
  return (
    <>
      <div className="body">
        <RestaurantCard restaurant={RestaurantList[0].info.name} />
        <RestaurantCard restaurant={RestaurantList[1].info.name} />
        <RestaurantCard restaurant={RestaurantList[2].info.name} />
        <RestaurantCard restaurant={RestaurantList[3].info.name} />
        <RestaurantCard restaurant={RestaurantList[4].info.name} />
      </div>
    </>
  );
};
